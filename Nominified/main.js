...
const errorMessage =
  "Désolé, je ne suis pas disponible pour le moment mais vous pouvez " +
      ...
      .done(function(data) {
        ...
        if (!data.success) {
          ...
          if (data.message == "Error") {
            text =
              "Une erreur semble s'être produite, merci de réessayer dans quelques instants";
          }
          // handle errors for email ---------------
          if (data.message == "Recaptcha error") {
            text =
              "Il semblerait que vous soyez un robot, si ce n'est pas le cas, merci de réessayer dans quelques instants";
          }
          if (data.message == "error empty") {
            text =
              "Il semblerait que vous tentiez de m'envoyer un message vide, merci de remplis les champs! Si ce n'est pas le cas, merci de réessayer dans quelques instants";
          }
        } else {
          text =
            "Le message à bien été envoyé, merci ! J'y répondrais le plus vite possible !";
        }
